...
<style>
  .btn-danger-soft {
    background: linear-gradient(135deg, #f7971e, #e05c2a);
    color: #fff;
    border: none;
  ...
  .btn-danger-soft:hover {
   ...
   .btn-save {
        background: linear-gradient(135deg, #2176ae, #57c4ad);
        color: #fff;
        border: none;
        padding: 0.45rem 1.2rem;
        border-radius: 6px;
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6">
      ...
      <div class="d-flex align-items-center justify-content-between mb-5">
        <a href="<?= site_url('user/profile') ?>" class="text-muted text-decoration-none" style="font-weight: bold">Annuler</a>
      ...
      <div class="danger-zone p-3 d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between gap-3">
        <div>
          <p class="mb-1 fw-500" style="font-weight: bold;">Supprimer mon compte</p>
